...
const button_address=process.env.button_address //wallet address of sender
const button_mnemonic=""//25 word pattern of address of sender
const red_address=process.env.red_address //address of red candidate 1
const blue_address=process.env.blue_address //address of blue candidate 2
